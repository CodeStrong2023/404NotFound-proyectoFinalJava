...
public class MenuRestaurante {
    ...
    public static void eliminar(ArrayList<Pedido> pedidos) {
        ...
        public static void realizarModificacion (ArrayList < Pedido > pedidos,int numeroPedidoAModificar, Pedido
        pedidoAModificar)
        {
            Scanner scanner = new Scanner(System.in);
            ...
            private static void guardarPedidosEnArchivo (ArrayList < Pedido > pedidos, String nombreUsuario, String
            direccion,double valorTotalCompra){
                int largoCompra = 0;
                String rutaEscritorio = System.getProperty("user");
                String archivoPedidos = rutaEscritorio + "pedidos.txt";
